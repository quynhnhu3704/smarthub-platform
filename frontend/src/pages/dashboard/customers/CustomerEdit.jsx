        ...
        <div className="card-na border-0" style={{ maxWidth: "32rem", width: "100%" }}>
          <div className="card-body p-4 position-relative">
            ...
            <form onSubmit={handleSubmit} spellCheck="false">
              ...
              <div className="mb-3">
                <label className="form-label fw-semibold">Tên khách hàng <span className="text-danger">*</span></label>
              ...
              <div className="row">
                ...
                <div className="col-6 mb-2">
                  <button type="reset" className="btn btn-outline-secondary fw-semibold w-100" onClick={() => setForm({ ...form, password: "" })} disabled={loading}>Đặt lại</button>
                </div>
              </div>
